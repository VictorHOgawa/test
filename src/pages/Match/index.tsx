...
export function Match2() {
  ...
  async function handleInteraction(action: string, index: number) {
    ...
    if (connect.status === 200 && connect.body.matchId !== null) {
      setMatchedProfile(connect.body.matched);
      setMatchId(connect.body.connect.body.matchId);
                ...
                >
                  <View className="h-screen w-screen overflow-hidden">
                    ...
                    <View className="absolute self-center top-72 z-20 flex flex-row">
                      ...
                      >
                        <Image
                          source={{ uri: matchedProfile?.photos[0].photo_location }}
                  ...
                  colors={["#56128d", "#e80062"]}
                  style={{
                    display: matchGifLoading ? "flex" : "none",
                  }}
                >
                  <VerticalView style={{ width: "60%" }}>
                    <Name>{matchedProfile?.name}</Name>
                    <Recently>
                      {matchedProfile?.name} estava presente em{" "}
                      {type === "event"
                        ? matchedProfile?.event.name
                        : matchedProfile?.place.name}
                      {""}
                      {""} há pouco
                    </Recently>
                  </VerticalView>
                  ...
                  />
                        ...
                        >
                          ...
                          >
                            <Text className=" text-white font-poppinsRegular">
                              Continuar Escrolando
                            </Text>
                          </TouchableOpacity>
                        </RNAnimated.View>
                        <View className="flex-1 items-center justify-center z-30">
                          {/* <Text className="text-5xl text-white font-dancingScript">
                        {" "}
                        its a match
                      </Text> */}
                        ...
                        <Image
                          ...
                          className="w-32 rounded-full h-32"
                        />
                        <View className="w-32 -ml-10 overflow-hidden  rounded-full border-2 border-[#B055E9] h-32">
                          <Image
                            source={require("../../../assets/Match/photo.png")}
                            className="w-full h-full"
                          />
